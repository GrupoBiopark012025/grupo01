...
const doc = {
  ...
  components: {
    schemas: {
      ...
      ImportActionPlanError: {
        error: "Erros de validação do plano de ação:\nCampo 'number' (número do plano) é obrigatório na primeira linha\nCampo 'what' (o que) é obrigatório na primeira linha"
      },

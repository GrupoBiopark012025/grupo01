...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  imports: [ZardPaginationContentComponent, ZardPaginationItemComponent, ZardPaginationButtonComponent, LucideAngularModule],
  template: `
    <z-pagination-content>
      <z-pagination-item>
        <z-pagination-button aria-label="Go to previous page" [zSize]="zSize()" [zDisabled]="disabled() || currentPage() === 1" (zClick)="goToPrevious()">
          <i-lucide [img]="icons.chevronLeft" />
        </z-pagination-button>
      </z-pagination-item>
      ...
      <z-pagination-item>
        <z-pagination-button aria-label="Go to next page" [zSize]="zSize()" [zDisabled]="disabled() || currentPage() === zTotal()" (zClick)="goToNext()">
          <i-lucide [img]="icons.chevronRight" />
        </z-pagination-button>
      </z-pagination-item>
    </z-pagination-content>
  `,
